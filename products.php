        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <a href="create_product.php">
                    <button type="submit" name="add" class="btn btn-primary mb-3"> Create New Product</button>
                </a>
